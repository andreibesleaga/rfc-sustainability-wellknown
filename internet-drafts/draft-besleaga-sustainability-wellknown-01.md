...
docname: draft-besleaga-sustainability-wellknown-01
category: info
...
informative:
  GHG-PROTOCOL:
    ...
    date: 2004
  GSF-SCI:
    title: "Software Carbon Intensity (SCI) Specification, v1.0 (later standardized as ISO/IEC 21031:2024)"
    author:
  ...
  W3C-WSG:
    ...
    date: 2023
  CARBON-TXT:
    title: "carbon.txt: A Proposed Convention for Discovering Sustainability Disclosures"
    author:
...
* Servers SHOULD implement the latest schema version they support.
...
* Replaced "standardized" with "uniform convention" in the Abstract, to reflect that this is an Informational document describing a common, interoperable convention (suited to the Independent Submission Stream and Research Group discussion) rather than a standards-track specification.
