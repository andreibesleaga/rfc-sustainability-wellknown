...
| N4 | Support optional ~1% multiplicative (sign-preserving) fuzzing of numeric fields (applied once at generation time, deterministic per reporting period, consistent across related fields; non-negative members stay non-negative). | §"Hardware Fingerprinting" |
