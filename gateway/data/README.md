...
use the same `urn:uuid:96a3b405-2151-4b00-842e-02a5260331c1` name with a `pue`
member — an illustrative name for data defined outside the specification, minted
for these two files. The
third,
