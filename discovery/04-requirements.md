...
| N4 | Support optional ~1% fuzzing of numeric fields (applied once at generation time, deterministic per reporting period, consistent across related fields; never on the sentinel). | §"Hardware Fingerprinting" |
