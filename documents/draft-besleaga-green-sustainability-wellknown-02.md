...
docname: draft-besleaga-green-sustainability-wellknown-02
category: info
submissiontype: IETF
ipr: trust200902
...
* **granularity**: Defines the "slices" within a period (e.g., `monthly`, `weekly`, `daily`). If granularity is finer than the period, the server SHOULD return an array of objects.
...
sustainability-metrics = {
  ...
  ; Timeframe of the report (RFC3339 formatted string, e.g. "YYYY", "YYYY-MM", "YYYY-MM-DD")
...
`GET /.well-known/sustainability?target=/api/v1&period=2026&granularity=monthly`
